...
addpath('/Users/jamesf/Dropbox/Matlab/polarELF1.7.1 171108');
addpath('/Users/jamesf/Dropbox/Matlab/veps/io')
elf_paths;

%%
dts = '/Users/jamesf/Documents/Starry Project/Light Pollution Imaging/LPexper-20181127-LowMWay-Thornwood/radiance/';
para = elf_para(dts);
% para.paths.projfolder = dts;
[~, ~, datasets] = elf_checkdata(para);
nohor = [NaN NaN];

for i = 1:length(datasets)%[3 6]%
    dataset = datasets{i};
    night_HDRscenes_JJF2019(dataset, nohor(i));
