%% James milky way
%relies on functions from the toolboxes:
%       image_processing
%       curve_fitting
%       parallel_processing
%       Communications
...
addpath('/Users/jamesf/Dropbox/Matlab/veps/io');%'E:\sprograms\veps');
addpath('/Users/jamesf/Dropbox/Matlab/2017 Milky Way contrast');%'E:\sprograms\veps');
veps_paths;
...
r_all = [90,90];% SEEMS TO BE TWO SCENES
...
% i = 1;
for i = 1:length(allfiles)
    irrad = milkyway_irradiance_JJF(strcat(allfiles(i).folder, '/',allfiles(i).name)); % in photons / s / m2 / nm
