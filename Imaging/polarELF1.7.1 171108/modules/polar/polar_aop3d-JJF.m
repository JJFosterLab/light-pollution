...
[posx, posy, posz] = stitch_rot3D(posx, posy, posz, 00, 'y');%-90, 'y');  % this is 0/0/1 for the centre of image 1
pos = [posx(:) posy(:) posz(:)];
...
%     % If such a corection is neccesary, this is not the way to do it.
