...
addpath(fullfile(getenv('HOME'),'Dropbox/Matlab/polarELF1.7.1 171108'));%'/Users/jamesf/Dropbox/Matlab/polarELF1.7.1 171108');
elf_paths;
% drs = {['/Volumes/Big backup 2/20181122MaxGibbousWits/set1']%,
drs = {['/Users/jamesf/Documents/Lunar DoLP/20181122MaxGibbousWits/set1']%,
    %['/Users/jamesf/Documents/Lunar DoLP/',...'/Users/jamesfoster/Documents/',
    %'20181130-NoonSun-Thornwood/set1'];
%     ['/Users/jamesf/Documents/Lunar DoLP/',...
%     '20181130BeforeThirdQuarter-Thornwood/set2'],
%     ['/Users/jamesf/Documents/Lunar DoLP/',...
%     '20181117PastFirstQuarter-Stonehenge/set1'],
%     ['/Users/jamesf/Documents/Lunar DoLP/',...
%     '20181115FirstQuarterMoon-Stonehenge/set1']
%     ''/Volumes/BIG BACKUP/Lunar DoLP/'20170130-eveningsun-Stonehenge/set1']
    ...'20170910-waninggibbous-Illmitz',...
    ...'/Users/jamesf/Documents/Lunar DoLP/20170304-clearquartermoon-tower-Sodankylä/set1',...['/Users/jamesf/Documents/Lunar DoLP/'...
     ...'/Users/jamesf/Documents/Lunar DoLP/20171128-quartermoonovercast-Thornwood/',...'20170304-clearquartermoon-tower-Sodankylä/set1/',
    ...['/Users/jamesf/Documents/Lunar DoLP/','20171123-crescentmoonclear-Thornwood'], ...'/Users/jamesf/Documents/Lunar DoLP/20161116-gibbousmoon2-Stonehenge/set1',...
     };%['/Users/jamesf/Documents/Lunar DoLP/','20161108-quartermoon-Stonehenge']'/Users/jamesf/Documents/Lunar DoLP/20161118-quartermoonhorizon2-Stonehenge/set2/'};
for dnow = 1:length(drs)
    ddd = drs{dnow}
    ...
    para = elf_para(ddd);%20171128-quartermoonovercast-Thornwood/');%'G:\20161113-fullmoonclear1-Stonehenge\set2');
    ...
    save(strcat(para.paths.root, '/ints.mat'), 'intim')
    save(strcat(para.paths.root, '/dolp.mat'), 'dolpim')
    save(strcat(para.paths.root, '/aop3d.mat'), 'aop3d_surf')
    save(strcat(para.paths.root, '/aopos.mat'), 'pos')
end %for dnow = 1:length(drs)