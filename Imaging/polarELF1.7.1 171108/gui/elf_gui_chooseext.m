function outext = elf_gui_chooseext(foldername)
...
%% check input
% Argument 2 is checked below, once the number of unique extensions is known.
if nargin < 1 % only for testing
    foldername = 'J:\Data and Documents\data\2014 VEPS test data\Hasthage_hovmansbygd_10mars1730';
    foldername = 'J:\Data and Documents\data\2014 VEPS test data\UW Hopkins MS April 06';
end
...
for extnum = 1:length(uniqueexts)
...
%% display first image, and image properties
    ...
    if validim
        if exifvalid
            % i) load first image and plot it
