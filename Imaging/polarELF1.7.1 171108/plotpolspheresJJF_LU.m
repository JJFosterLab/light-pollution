...
load(['/Users/jamesf/Documents/Lunar DoLP/20181122MaxGibbousWits/set1/'...
       'ints.mat'])% 
load(['/Users/jamesf/Documents/Lunar DoLP/20181122MaxGibbousWits/set1/'...'20161116-gibbousmoon2-Stonehenge/set1/'...'20170130-MilkyWay-Stonehenge/'...'20161118-quartermoonhorizon2-Stonehenge/set2/'...
    'aop3d.mat'])% 
load(['/Users/jamesf/Documents/Lunar DoLP/20181122MaxGibbousWits/set1/'...'20161116-gibbousmoon2-Stonehenge/set1/'...'20170130-MilkyWay-Stonehenge/'...'20161118-quartermoonhorizon2-Stonehenge/set2/'...
    'aopos.mat'])% 
load(['/Users/jamesf/Documents/Lunar DoLP/20181122MaxGibbousWits/set1/'...'20161116-gibbousmoon2-Stonehenge/set1/'...'20170130-MilkyWay-Stonehenge/'...'20161118-quartermoonhorizon2-Stonehenge/set2/'...
...
saveas(gcf, '/Users/jamesf/Documents/Lunar DoLP/FullMoonWitsInt.pdf',  'pdf')
hold on
% figure();set(gcf,'Position', [1920/3,1920/2,1.05*1920/3,1920/3])
polar_plot_aop3d(pos, aop3d_surf{3},gcf, 0.1, 1.01);view(0,90); axis square; axis off
view(340, 25)
saveas(gcf, '/Users/jamesf/Documents/Lunar DoLP/FullMoonAOP.pdf',  'pdf')

figure();set(gcf,'Position', [1920/3,1920/2,1.05*1920/3,1920/3])
polar_plot_dolp3d(dolpim{3}, gca, 0, 1);view(0,90); axis square; axis off; hold on
saveas(gcf, '/Users/jamesf/Documents/Lunar DoLP/FullMoonWitsDoLP.pdf',  'pdf')
