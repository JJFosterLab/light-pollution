function [p, D0] = veps_stats_areatest(R1, R2, E, reps, dist_degree, plotall, blocksize)
...
D       = veps_stats_areadiff(R1_m, R2_m, E, dist_degree);
...
D0      = veps_stats_areadiff(R1_m0, R2_m0, E, dist_degree); % calculate the total area between the mean curves for real data 
...
if plotall
    figure(71); clf;
    subplot(1, 3, 1);
    plot(veps_stats_normalise(R1, E), E);
    hold on;
    plot(veps_stats_normalise(R1_m0, E), E, 'r', 'linewidth', 3);
    ylabel('Elevation (\circ)');
    title('Env. 1');

    subplot(1, 3, 2);
    plot(veps_stats_normalise(R2, E), E);
    hold on;
    plot(veps_stats_normalise(R2_m0, E), E, 'b', 'linewidth', 3);
    xlabel('Norm. radiance');
    title('Env. 2');
    set(gca, 'YTick', []);

    subplot(1, 3, 3);
    plot(veps_stats_normalise(R1_m0, E), E, 'r', veps_stats_normalise(R2_m0, E), E, 'b', 'linewidth', 3);
    set(gca, 'YTick', []);
