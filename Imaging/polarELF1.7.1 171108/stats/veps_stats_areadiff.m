function D = veps_stats_areadiff(R1, R2, E, dist_degree)
%
% Inputs:
...
%
% veps_stats -> veps_stats_areatest -> veps_stats_areadiff -> veps_stats_normalise
...
R1                  = log10(veps_stats_normalise(R1, E));   % normalise radiances, then take the log
R2                  = log10(veps_stats_normalise(R2, E));   % normalise radiances, then take the log
