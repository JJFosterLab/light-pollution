    ...
    case {'equisolid', 'default'}
        ...
        switch lower(I_info.Model{1})
            ...
            case 'nikon d800e'
                ...
                warning('No calibration available for Nikon D800E. Using an estimated calibration for an equisolid projection.');
                corr = 1.02;
            case 'nikon d810'
                corr = 1;
            ...
            case 'nikon d5300'
                ...
                corr = 1.35;
            otherwise
                warning('No calibration available for this camera (%s) and lens. Assuming perfect equisolid projection on full size chip', I_info.Model{1});
                corr = 1;
        end
