...
if nargin < 4, calib = 0; end
if nargin < 3, name = 'no name'; end
if nargin < 2, fh = elf_support_formatA4(1); end
...
elf_plot_spatial(para, res.spatial, ax5, res.totalint.region_meanele);
