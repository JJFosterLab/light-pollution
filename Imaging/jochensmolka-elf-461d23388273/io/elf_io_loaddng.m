...
% uncompressed.
warning('error', 'MATLAB:imagesci:tiffmexutils:libtiffErrorAsWarning'); %#ok<CTPCT>
...
try
    ...
    switch err.identifier
        case 'MATLAB:imagesci:tiffmexutils:libtiffErrorAsWarning'
            error('ELF:io:dngCompressed', 'DNG image appears to have been converted wrong (not using "Uncompressed" setting)');
        otherwise
            warning(err)
    end
end
